...
export const Hero = () => {
  return (
    <div data-aos="fade-right" className='w-full items-center md:gap-6 md:flex-row h-auto lg:flex-row flex-col lg:h-[90vh] transition-all bg-[#ffb703] px-7 lg:px-[100px] flex justify-between py-[30px]'>
        <div>
