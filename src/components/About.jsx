...
export const About = () => {
  return (
    <div data-aos="fade-up" name="about" id="nava" className='w-full  md:flex-row nav gap-4 mb-[40px] transition-all py-[60px] h-auto lg:h-[60vh] body lg:flex-row flex-col md:gap-8 md:items-center flex justify-between lg:px-[100px] px-4'>
        <div>
